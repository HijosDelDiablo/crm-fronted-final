...
import { User, Camera, Mail, Phone, MapPin, Calendar, Save } from "lucide-react";
...
export default function Perfil() {
  ...
  const handleFileChange = async (e) => {
    ...
    if (file.size > 5 * 1024 * 1024) return toast.error("La imagen no debe pesar más de 5MB");
    ...
    setUploading(true);
    try {
      const { data } = await api.post("/user/profile/upload-photo", formDataImg, {
        ...
        <Col md={4} lg={3}>
          <div className="product-card text-center p-4 h-100">
            <div className="position-relative d-inline-block mb-3">
              ...
              {uploading && (
                <div className="mt-2">
                  <Spinner animation="border" size="sm" variant="primary" /> <small>Subiendo...</small>
                </div>
              )}
            </div>
            ...
            <div className="text-start mt-4">
              <div className="d-flex align-items-center gap-2 mb-2 text-muted">
                <Mail size={16} /> <small className="text-truncate">{reduxUser?.email}</small>
              </div>
          ...
          <div className="product-card p-4 h-100">
            ...
            <Form onSubmit={handleSubmit}>
              <Row className="g-3">
                <Col md={6}>
                  <Form.Group>
                    <Form.Label className="small text-muted">Nombre Completo</Form.Label>
                ...
                <Col md={6}>
                  <Form.Group>
                    <Form.Label className="small text-muted">Correo Electrónico</Form.Label>
                    <div className="input-group">
                ...
                <Col md={6}>
                  <Form.Group>
                    <Form.Label className="small text-muted">Fecha de Nacimiento</Form.Label>
                    <div className="input-group">
              ...
              <div className="d-flex justify-content-end mt-4">
                <Button 
                  ...
                  disabled={loading}
                >
                  {loading ? <Spinner size="sm" animation="border" /> : <Save size={18} />}
                  Guardar Cambios
                </Button>
              </div>
            </Form>
