                ...
                <div className="product-card h-100 d-flex flex-column">
                  ...
                  >
                    <img
                      src={
                        coche.imageUrl ||
                        "https://via.placeholder.com/400x300?text=Auto"
                      }
                      alt={coche.modelo}
                    ...
                    <Badge
                      bg={statusCfg.color}
                      className="product-badge d-flex align-items-center gap-1"
                    >
                    ...
                    <div className="p-3 bg-light rounded mb-3">
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className="fw-bold">
                          ${compra.cotizacion?.enganche?.toLocaleString()}
                        </span>
                      </div>
                      <div className="d-flex justify-content-between">
                        <span>Mensualidad (Est):</span>
                        <span className="fw-bold text-primary">
                          ${compra.cotizacion?.pagoMensual?.toLocaleString()}
                        </span>
                      </div>
                    </div>
            ...
            <Modal.Body className="p-4">
              ...
              {selectedCompra.status === "Rechazada" && (
                <div className="text-center">
                  ...
                  <p className="text-muted">
                    Lamentablemente, en este momento no podemos ofrecerte el
                  ...
                  <div className="bg-light p-3 rounded text-start mt-4">
                    ...
                    <p className="mb-0">
                      {selectedCompra.resultadoBanco?.motivoRechazo ||
                        "No cumple con las políticas de riesgo actuales."}
                    </p>
                  </div>
                  ...
                  {selectedCompra.resultadoBanco?.sugerencias && (
                    <div className="mt-3 text-start">
                      ...
                      <ul className="text-muted small mt-1">
                        {selectedCompra.resultadoBanco.sugerencias.map(
                          (s, i) => (
                            <li key={i}>{s}</li>
                          )
                        )}
